...
#
# -- Lumos : Virtual Machine
# The virtual machine takes the intermediate code 
# (.lumos) generated by the parser and executes it.
# --------------------------------------------------
